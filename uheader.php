...
if($_SESSION['a' . $user_id] == 'Share' && $banner == 'ON' && $port_id == $_POST['id']){
    ...
    echo "<div id=box >
    Channel Occupy &nbsp;&nbsp; Channel no: $port_id  &nbsp; &nbsp;Portname:&nbsp; $portname
    </div>";
    ?>
...
$sql=$updatedata->requestPortAccess($user_id,$portname,$decoder_name,$port_id); 
