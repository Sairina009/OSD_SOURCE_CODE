...
switch($_SESSION['la'] ?? ''){
case "sc":
    include 'hotkey/sc.php';    
    break;
case "ca":
    include 'hotkey/ca.php';    
    break;
case "ct":
    include 'hotkey/ct.php';    
    break;  
default: 
    include 'hotkey/sc.php';    
}
...
<link rel="stylesheet" href="css/usercss/bootstrap.min.css.map" type="text/css" rel="stylesheet"> <style>
...
<header class="header" style="background-color: floralwhite;font-size: medium;">
    ...
    <div class="container-fluid"
        ...
        <ul class="nav nav-tabs" style=width:1730px;height:900px;margin-top:10px;margin-left:40px>
            <li class="nav-item <?php echo ($_SERVER['PHP_SELF'] == '/userdemo.php') ? 'active' : ''; ?>">
        <a class="nav-link" href="userdemo.php"><?php echo $lang['H2']; ?></a></li>
            <li class="nav-item <?php echo ($_SERVER['PHP_SELF'] == '/userhelp.php') ? 'active' : ''; ?>">
        <a class="nav-link" href="userhelp.php"><?php echo $lang['H7']; ?></a></li>

         </ul>
        <div style="border:1px solid black;padding:2px;height:842px;margin-top:-856px;width:1851px;margin-left:41px">
        </div>
    </div>
    <div id=display style=margin-left:89px;margin-top:-815px>
        <label><?php echo $lang['A1']; ?></label><br>
        <?php $sql=$updatedata->help();
        ?><label><?php echo $lang['A2']; ?></label><br>
        <label><?php echo $lang['A3']; ?></label> <br>
        <label><?php echo $lang['A4']; ?></label>
    </div>