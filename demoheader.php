...
if (isset($_GET['la'])) { 
    ...
    switch($_SESSION['la'] ?? '')
    { 
case "sc": include 'hotkey/sc.php';
    break; 
case "ca": include 'hotkey/ca.php';
    break; 
case "ct": include 'hotkey/ct.php';
    break; 
default: include 'hotkey/sc.php';
    }
    ?>
<!DOCTYPE html>
<html lang=en>
...
<header class="header" style="background-color: floralwhite;font-size: medium;">
    ...
    <div class="container-fluid"
     ...
     <ul class="nav nav-tabs" style=width:1730px;height:900px;margin-top:10px;margin-left:40px>
        <li class="nav-item <?php echo ($_SERVER['PHP_SELF'] == '/od/userdemo.php') ? 'active' : ''; ?>">
        <a class="nav-link" href="userdemo.php"><?php echo $lang['H2']; ?></a></li>
        <li class="nav-item <?php echo ($_SERVER['PHP_SELF'] == '/od/userhelp.php') ? 'active' : ''; ?>">
